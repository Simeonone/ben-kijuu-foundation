...
try {
    ...
    $result = $pdo->query("SHOW COLUMNS FROM event_registrations LIKE 'total_amount'");
    if ($result->rowCount() == 0) {
        $pdo->exec("ALTER TABLE event_registrations ADD COLUMN total_amount DECIMAL(10,2) DEFAULT 0.00 AFTER special_requirements");
